          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="bg-white dark:bg-[#252525] rounded-xl shadow-lg p-4 sm:p-6">
              ...
              <div className="flex flex-wrap gap-3 sm:gap-4">
                {/* Facebook */}
                <a href="#" className="w-11 h-11 sm:w-12 sm:h-12 bg-[#252525] hover:bg-[#E5C16C] rounded-lg flex items-center justify-center transition-colors duration-300 group shrink-0">
