...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative bg-[#1A1A1A] text-white py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8 mt-16 sm:mt-20 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 leading-tight">
            <span className="text-[#E5C16C]">Contactez</span>-Nous
          </h1>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl mb-6 sm:mb-8 text-gray-300 max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-4 sm:p-6 md:p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 sm:px-4 py-2.5 sm:py-3 text-sm sm:text-base border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#A73B3C] focus:border-transparent bg-white dark:bg-[#252525] text-[#1A1A1A] dark:text-white"
              ...
              <button
                ...
                className="w-full bg-[#A73B3C] hover:bg-[#8B3032] disabled:bg-gray-400 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold text-base sm:text-lg transition-colors flex items-center justify-center gap-2"
              >
                {isSubmitting ? (
                  <>
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="grid gap-4 sm:gap-6">
              {contactInfo.map((info, index) => (
                <div key={index} className="bg-white dark:bg-[#252525] rounded-xl shadow-lg p-4 sm:p-6">
                  <div className="flex items-start gap-3 sm:gap-4">
                    <div className="p-2 sm:p-3 bg-[#E5C16C]/20 rounded-xl shrink-0">
                      {getContactIcon(info.type)}
                    </div>
                    <div className="flex-1 min-w-0">
                      <h3 className="text-lg sm:text-xl font-bold text-[#1A1A1A] dark:text-white mb-1.5 sm:mb-2">
                        {info.title}
                      </h3>
                      {info.details.map((detail, idx) => (
                        <p key={idx} className="text-sm sm:text-base text-gray-600 dark:text-gray-300 mb-1 wrap-break-word">
                          {detail}
                        </p>
                      ))}
                      {info.link && (
                        <a
                          href={info.link}
                          className="text-sm sm:text-base text-[#A73B3C] hover:text-[#E5C16C] hover:underline font-medium mt-1.5 sm:mt-2 inline-block transition-colors"
                        >
            ...
            {/* Social Media Links */}
            <div className="bg-white dark:bg-[#252525] rounded-xl shadow-lg p-4 sm:p-6">
              <h3 className="text-lg sm:text-xl font-bold text-[#1A1A1A] dark:text-white mb-3 sm:mb-4">
                Suivez-Nous
              </h3>
              ...
              <div className="flex flex-wrap gap-3 sm:gap-4">
                {/* Facebook */}
                <a href="https://www.facebook.com/navettexpresssenegal" aria-label="Suivez-nous sur Facebook" className="w-11 h-11 sm:w-12 sm:h-12 bg-[#252525] hover:bg-[#E5C16C] rounded-lg flex items-center justify-center transition-colors duration-300 group shrink-0">
                ...
                {/* TikTok */}
                <a href="https://www.tiktok.com/@navettexpresssenegal" aria-label="Suivez-nous sur TikTok" className="w-11 h-11 sm:w-12 sm:h-12 bg-[#252525] hover:bg-[#E5C16C] rounded-lg flex items-center justify-center transition-colors duration-300 group shrink-0">
                ...
                {/* Instagram */}
                <a href="https://www.instagram.com/navettexpresssenegal" aria-label="Suivez-nous sur Instagram" className="w-11 h-11 sm:w-12 sm:h-12 bg-[#252525] hover:bg-[#E5C16C] rounded-lg flex items-center justify-center transition-colors duration-300 group shrink-0">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
                ...
                {/* LinkedIn */}
                <a href="https://www.linkedin.com/company/navettexpresssenegal" aria-label="Suivez-nous sur LinkedIn" className="w-11 h-11 sm:w-12 sm:h-12 bg-[#252525] hover:bg-[#E5C16C] rounded-lg flex items-center justify-center transition-colors duration-300 group shrink-0">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Emergency Contact */}
            <div className="bg-[#A73B3C]/10 border border-[#A73B3C]/30 rounded-xl p-4 sm:p-6">
              <div className="flex items-start gap-3 sm:gap-4">
                <div className="text-2xl sm:text-3xl shrink-0">🚨</div>
                <div className="flex-1 min-w-0">
                  <h3 className="text-lg sm:text-xl font-bold text-[#A73B3C] mb-1.5 sm:mb-2">
                    Urgence 24h/24
                  </h3>
                  <p className="text-sm sm:text-base text-[#1A1A1A] dark:text-gray-300 mb-2 sm:mb-3">
                    En cas d&apos;urgence ou pour une réservation de dernière minute
                  </p>
                  <a
                    href="tel:+221781319191"
                    className="bg-[#A73B3C] hover:bg-[#8B3032] text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg font-semibold text-sm sm:text-base transition-colors inline-flex items-center gap-2"
                  >
                    📞 Appeler l&apos;urgence
                  </a>
                </div>
      ...
      {/* CTA Section */}
      <section className="py-10 sm:py-12 md:py-16 px-4 sm:px-6 md:px-8 bg-[#A73B3C] text-white">
