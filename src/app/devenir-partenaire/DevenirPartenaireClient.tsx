...
export default function DevenirPartenaireClient() {
  ...
  return (
    <div className="min-h-screen flex bg-[#0A0A0F] font-sans selection:bg-[#C9A84C]/30 selection:text-[#E8C97A]">
      <AnimatePresence mode="wait">
        {isSubmitted ? (
          ...
          <div key="form" className="flex w-full">
            ...
            <div className="hidden lg:flex lg:w-2/5 relative overflow-hidden flex-col bg-[#07070B] border-r border-white/5">
              {/* Orbes flottantes */}
              ...
              <div className="relative z-10 flex flex-col h-full px-12 py-12">
                ...
                <div className="flex items-center justify-between mb-20">
                  <Link href="/" className="flex items-center gap-3 transition-transform hover:scale-105">
                    <div className="w-10 h-10 bg-[#C9A84C] rounded-lg flex items-center justify-center shadow-[0_0_20px_rgba(201,168,76,0.3)]">
                      <span className="text-[#0A0A0F] font-bold text-xl">NX</span>
                    </div>
                    <div>
                      <p className="text-white font-semibold">Navette <span className="text-[#C9A84C]">Xpress</span></p>
                      <p className="text-[10px] text-white/40 uppercase tracking-widest">Premium Partner</p>
                    </div>
                  </Link>
                  <Link href="/" className="group flex items-center gap-2 text-white/50 hover:text-white transition-colors text-xs uppercase tracking-widest">
                ...
                <div className="my-auto">
                  <motion.h1
                    ...
                    className="text-5xl leading-tight text-white mb-8 font-serif italic"
                    style={{ fontFamily: 'var(--font-display, serif)' }}
                  >
                    Rejoignez l&apos;élite des <br />
                    <span className="text-[#C9A84C] not-italic font-bold">Chauffeurs Partenaires</span>
                  </motion.h1>
                  ...
                  <div className="space-y-6 mb-12">
                    {[
                      ...
                      >
                        <div className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-[#C9A84C] group-hover:bg-[#C9A84C]/10 group-hover:border-[#C9A84C]/30 transition-all">
                          {item.icon}
                        </div>
                        <div>
                  ...
                  <motion.div
                    ...
                    className="p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm shadow-2xl"
                  >
                    ...
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-[#C9A84C]/20 flex items-center justify-center text-[#C9A84C] text-xs font-bold">MK</div>
                      <p className="text-xs text-white/50 uppercase tracking-widest font-bold">— Moussa K., Chauffeur Partenaire</p>
                    </div>
                  </motion.div>
                </div>
                ...
                <div className="flex justify-between items-center mt-auto pt-8 border-t border-white/5">
                  {[
                    ...
                    <div key={i} className="text-center">
                      <p className="text-[#C9A84C] font-mono text-lg font-bold">{stat.val}</p>
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar flex flex-col items-center py-20 px-6 sm:px-12">
              ...
              >
                <div className="mb-12">
                  <span className="inline-block px-3 py-1 bg-[#C9A84C]/10 border border-[#C9A84C]/20 rounded-full text-[#C9A84C] text-[10px] font-bold uppercase tracking-widest mb-4">
                    Formulaire de candidature
                  </span>
                  <h2 className="text-4xl text-white font-serif mb-4" style={{ fontFamily: 'var(--font-display, serif)' }}>
                    Postulez dès <span className="text-[#C9A84C] italic">maintenant</span>
                  </h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-10">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center gap-3 pb-2 border-b border-white/5">
                      ...
                      <h3 className="text-white font-medium uppercase text-xs tracking-widest">Votre Identité</h3>
                    </div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center gap-3 pb-2 border-b border-white/5">
                      ...
                      <h3 className="text-white font-medium uppercase text-xs tracking-widest">Votre Véhicule</h3>
                    </div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center gap-3 pb-2 border-b border-white/5">
                      ...
                      <h3 className="text-white font-medium uppercase text-xs tracking-widest">Motivation & Disponibilité</h3>
                    </div>
                    ...
                    <div className="space-y-2">
                      <label className="text-[10px] uppercase tracking-widest text-white/40">Vos motivations</label>
                      <textarea
                        name="motivation"
                        ...
                        className="w-full bg-white/[0.03] border border-white/10 rounded-xl p-4 text-white text-sm outline-none focus:border-[#C9A84C]/50 focus:bg-white/[0.05] transition-all resize-none"
                      />
                    </div>
                  </div>
                  ...
                  <div className="pt-6">
                    <button
                      ...
                      className="group relative w-full py-5 bg-[#C9A84C] hover:bg-[#E8C97A] text-[#0A0A0F] rounded-2xl font-bold text-lg transition-all active:scale-[0.98] disabled:opacity-50 disabled:pointer-events-none shadow-[0_10px_30px_rgba(201,168,76,0.3)]"
                    >
...
function FormInput({ label, name, type = "text", placeholder, value, onChange, required = false }: any) {
  return (
    <div className="space-y-2">
      <label className="text-[10px] uppercase tracking-widest text-white/40">{label} {required && "*"}</label>
      <input
        type={type}
        name={name}
        ...
        onChange={onChange}
        required={required}
        className="w-full bg-white/[0.03] border border-white/10 rounded-xl px-4 py-3.5 text-white text-sm outline-none focus:border-[#C9A84C]/50 focus:bg-white/[0.05] transition-all"
      />
    </div>
  );
}
  ...
  return (
    <div className="space-y-2">
      ...
      <select
        ...
        required={required}
        disabled={disabled}
        className="w-full bg-white/[0.03] border border-white/10 rounded-xl px-4 py-3.5 text-white text-sm outline-none focus:border-[#C9A84C]/50 focus:bg-white/[0.05] transition-all appearance-none cursor-pointer disabled:opacity-30"
      >
        <option value="" className="bg-[#0A0A0F]">Choisir...</option>
        {options.map((opt: any) => (
  ...
  return (
    <label className="flex items-center gap-3 cursor-pointer group">
      <div className="relative">
        ...
        />
        <div className="w-5 h-5 border-2 border-white/10 rounded-md bg-white/5 peer-checked:bg-[#C9A84C] peer-checked:border-[#C9A84C] transition-all" />
        <CheckCircle2 size={12} className="absolute inset-0 m-auto text-[#0A0A0F] opacity-0 peer-checked:opacity-100 transition-opacity" />
      </div>
...
function SuccessState() {
  return (
    ...
    >
      <div className="w-24 h-24 bg-[#C9A84C]/10 border border-[#C9A84C]/30 rounded-full flex items-center justify-center mb-8 relative">
        <motion.div
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
      ...
      <h1 className="text-5xl text-white font-serif mb-6" style={{ fontFamily: 'var(--font-display, serif)' }}>
        Candidature <span className="text-[#C9A84C] italic font-normal">Reçue</span>
      </h1>
      <p className="max-w-[450px] text-white/50 mb-10 text-lg leading-relaxed">
        Merci de votre intérêt pour Navette Xpress. Notre département de gestion des partenaires va analyser votre profil. <br />
        <span className="text-white/80 font-medium">Vous recevrez une réponse sous 48h.</span>
      </p>

      <Link href="/">
        <button className="px-10 py-4 bg-white/5 border border-white/10 hover:bg-white/10 text-white rounded-2xl font-bold transition-all hover:scale-105 active:scale-95 flex items-center gap-2">
          <ArrowLeft size={18} />
          Retour à l&apos;accueil
        </button>
      </Link>
      ...
      <div className="orb-float absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#C9A84C]/5 blur-[100px] rounded-full -z-10" />
    </motion.div>
  );
}
