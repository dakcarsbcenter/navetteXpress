...
export function generateStaticParams() {
  return routing.locales.flatMap((locale) =>
    moneyRoutePages.map((page) => ({ locale, slug: page.slug }))
  );
}
...
export default async function RouteMoneyPage({ params }: Params) {
  ...
  const t = await getTranslations({ locale, namespace: 'routes.slugPage' });
  ...
  const breadcrumbs = [
    ...
    { name: t('breadcrumbRoutes'), item: buildAlternates('/routes', locale).canonical },
