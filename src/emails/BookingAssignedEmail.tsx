...
export default function BookingAssignedEmail({
  ...
  return (
    <Html lang="fr" dir="ltr">
      <Head />
      <Preview>Nouvelle course assignée - {bookingId}</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          {/* Titre principal */}
          <Heading style={h1}>🚗 Demande assignée</Heading>

          {/* Contenu */}
          <Text style={text}>Bonjour {driverName},</Text>

          <Text style={text}>
            Une nouvelle course vous a été assignée. Veuillez consulter les détails ci-dessous.
          </Text>

          {/* Info box */}
          <Section style={infoBox}>
            <Text style={infoLabel}>Référence de la course</Text>
            <Text style={infoValue}>{bookingId}</Text>
          </Section>

          {/* Détails de la course */}
          <Section style={detailsSection}>
            <Text style={detailTitle}>Détails de la course :</Text>
            
            <Text style={detailItem}>
              <strong>Client :</strong> {customerName}
            </Text>
            <Text style={detailItem}>
              <strong>Lieu de prise en charge :</strong> {pickupLocation}
            </Text>
            <Text style={detailItem}>
            ...
            <Text style={detailItem}>
              <strong>Heure de départ :</strong> {pickupTime}
            </Text>
          </Section>
          ...
          <Text style={footerSmall}>
            Cet email a été envoyé automatiquement. Pour toute question, contactez le support.
          </Text>
