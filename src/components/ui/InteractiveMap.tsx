...
export default function InteractiveMap({
  ...
  useEffect(() => {
    setIsClient(true);
    // Les icônes par défaut de Leaflet pointent vers des chemins résolus par
    // webpack qui n'existent pas tels quels une fois servis par Next.js —
    // on les repointe explicitement vers des copies statiques dans /public.
