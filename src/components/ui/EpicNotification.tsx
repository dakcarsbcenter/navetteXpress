      ...
      >
        ...
        <div className="h-5 bg-white/20 relative overflow-hidden">
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-white/60 via-white/95 to-white/60 animate-pulse" />
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/90 to-transparent animate-pulse" />
            <div className="absolute inset-0 bg-gradient-to-r from-white/40 via-white/95 to-white/40 animate-pulse" />
        ...
        <div className="p-6">
          <div className="flex items-start space-x-4">
            ...
            <div className={`
              flex-shrink-0 w-18 h-18 rounded-full ${styles.iconBg} 
        ...
        {/* Effet de vague */}
        <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-transparent via-white/5 to-transparent animate-pulse" />
      </div>
    </div>
  )
}
