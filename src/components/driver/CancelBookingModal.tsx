...
export function CancelBookingModal({
  ...
  const predefinedReasons = [
    { id: "vehicle_issue", label: "🔧 Problème technique avec le véhicule", icon: "🔧" },
    { id: "traffic", label: "🚦 Embouteillages importants / Route bloquée", icon: "🚦" },
    { id: "emergency", label: "🚨 Urgence personnelle", icon: "🚨" },
    { id: "weather", label: "🌧️ Conditions météorologiques dangereuses", icon: "🌧️" },
    { id: "illness", label: "🤒 Indisposition / Problème de santé", icon: "🤒" },
    { id: "customer_request", label: "📞 Demande du client", icon: "📞" },
    { id: "other", label: "✍️ Autre raison (préciser)", icon: "✍️" }
  ]
