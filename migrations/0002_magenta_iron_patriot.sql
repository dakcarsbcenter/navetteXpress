...
ALTER TABLE "users" DROP CONSTRAINT IF EXISTS "driver_license_check";--> statement-breakpoint
...
ALTER TABLE "users" ADD CONSTRAINT "driver_license_check" CHECK (("users"."role" != 'chauffeur') OR ("users"."license_number" IS NOT NULL));